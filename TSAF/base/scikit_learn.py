...
class LSTMRegressor(KerasRegressor):
    ...
    '''Extends keras regressor to fix size sequence input LSTM'''
    def score(self, x, y, **kwargs):
       return super(LSTMRegressor,self).score(x,y,**kwargs)
   
    
    '''Extends the keras regressor to fix size sequence-input LSTM'''
    def predict(self,x,**kwargs):
...
class LSTM(object):
    def __init__(self,n_neurons=16,stateful=False):
